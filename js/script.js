...
window.addEventListener('DOMContentLoaded', () => {
	...
	function __class() {
		...
		class SpecialMenu {
			...
			formatToEUR() {
				this.price = this.price.toLocaleString('uz-UK', {style:'currency', currency: 'EUR'});
			}
		...
		dayTimeItems.forEach(dayTimeItem => {
			const {src, alt, title, descr, startTime, endTime} = dayTimeItem;
